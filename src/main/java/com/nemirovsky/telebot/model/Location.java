...
public class Location {
    ...
    public String toString() {
        return "lat = " + this.latitude + "; lon = " + this.longitude + (this.accuracy < 0 ? "" : ("; accuracy = " + this.accuracy));
    }

    @Override
    public boolean equals(Object o) {
        if (this == o) return true;
        if (!(o instanceof Location) || o == null) return false;
        Location l = (Location) o;
        return l.latitude == this.latitude && l.longitude == this.longitude && l.accuracy == this.accuracy;
    }
    ...
    public static double distance(Location l1, Location l2) {
        ...
        double lat1 = l1.getLatitude() * Math.PI / 180.0;
        double lat2 = l2.getLatitude() * Math.PI / 180.0;
        double lon1 = l1.getLongitude() * Math.PI / 180.0;
        double lon2 = l2.getLongitude() * Math.PI / 180.0;
